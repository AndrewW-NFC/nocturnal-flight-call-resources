...
>
# Scripts for forecasting acoustic conditions
This forecasts and documents acoustic conditions for recording, such as low wind, no precipitation, cloud cover, etc.
* [NFC Acoustic Environment Forecast](https://andreww-nfc.github.io/nfc-acoustic-environment-forecast/)
* [Repo](https://github.com/AndrewW-NFC/nfc-acoustic-environment-forecast) for NFC Acoustic Environment Forecast
